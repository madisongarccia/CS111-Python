...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
       ...
       # somePlace = self.place
        #while somePlace != None and somePlace.is_hive ==False:
          #  if len(somePlace.bees) != 0:
       #         return random_bee(somePlace.bees)
         #   somePlace = somePlace.entrance
        #return None
         # REPLACE THIS LINE
        # END Problem 3 and 4
