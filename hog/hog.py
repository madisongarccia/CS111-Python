...
def picky_piggy(score): #score is opponent's current score
    ...
    if score%6==0:
        ...
        answer=(1/7)%(10**(1-(score%6)))
        answer=(answer*(10**(score%6)))//1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def helperFunc(score0,score1):
        ...
        if who == 0:
            ...
            score = score1
        if difference > new:
            print(f"{difference} point(s)! That's a record gain for Player {who}!")
            new = difference
        return announce_highest(who, score, new)
    return helperFunc
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    def avgTrials(*args):
        ...
        while counter < trials_count:
            NumeratorAvg= NumeratorAvg + original_function(*args)
            counter+=1
        return NumeratorAvg/trials_count
    return avgTrials
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while counter <= 10:
        ...
        max_score_count = averaged_roll_dice(counter, dice)
        if max_score_count > highestScore:
            highestScore = max_score_count
            maxScoreValue = counter
        counter += 1
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    score += picky_piggy(opponent_score)
    if score < opponent_score and hog_pile(score,opponent_score):
        return 0
